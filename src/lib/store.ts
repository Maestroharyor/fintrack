...
const dummyBudgets: Budget[] = [
  { id: "1", category: "Food", amount: 40000, spent: 25000, month: getCurrentMonth() },
  { id: "2", category: "Transport", amount: 20000, spent: 15000, month: getCurrentMonth() },
  { id: "3", category: "Entertainment", amount: 15000, spent: 8000, month: getCurrentMonth() },
  { id: "4", category: "Utilities", amount: 25000, spent: 0, month: getCurrentMonth() },
]
  ...
  persist(
    (set, get) => ({
      ...
      toggleTransactionComplete: (id) => {
        set((state) => ({
          transactions: state.transactions.map((t) => (t.id === id ? { ...t, completed: !t.completed } : t)),
        }))
      },
